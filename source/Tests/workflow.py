"""Independent short workflow IO boundaries; no repeated candidate compilation.
...
def main():
    ...
    if args.case == "intent":
        ...
        # this IO fixture intentionally has no acceptance materials or viewing resources.
